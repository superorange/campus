      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            title: Consumer<TradeInformationVm>(builder: (context, vm, _) {
              return Text(
                '${(vm.goodsListModel?.goodsModel?.first?.gPrice) ?? ""}',
                style: TextStyle(
                    ...
                    slivers: <Widget>[
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      '${vm.goodsListModel.goodsModel.first.gName}',
                                      style: TextStyle(
                                        color: Colors.black,
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ...
                                    Text(
                                      '${vm.goodsListModel.goodsModel.first.schoolLocation}',
                          ...
                          Container(
                            child: RichText(
                              text: TextSpan(children: [
                                ...
                                TextSpan(
                                    text:
                                        '${vm.goodsListModel.goodsModel.first.gDec}',
                                    style: TextStyle(
                                        color: Colors.black54,
                                        fontSize: 20,
                                        fontWeight: FontWeight.w500)),
                      ...
                      SliverList(
                        ...
                        return CachedNetworkImage(
                            imageUrl: vm.goodsListModel.goodsModel.first
                                .gImages[index]);
                      },
                              childCount: vm.goodsListModel.goodsModel.first
                                  .gImages.length)),
                      SliverToBoxAdapter(
                        child: Container(
                          height: 100,
                        ...
                        children: <Widget>[
                          ...
                          Flexible(
                            child: FlatButton(
                                ...
                                onPressed: () {
                                  Navigator.pushNamed(
                                      context, RouteName.chatPage, arguments: {
                                    'toId': widget.gId,
                                    'headPic': 'vm.goodsListModel.',
                                    'userName': 'vm.'
                                  });
                                },
                                child: Text('在线沟通')),
